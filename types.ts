...
export type ScreeningStatus =
  "planlandi" | "devam_ediyor" | "tamamlandi" | "iptal";
...
// Varsayılan görevlerin yanında kurumun kendi görev tanımları da eklenebilir.
...
export interface User {
  id: string;
  teamMemberId?: string; // Ekip kaydıyla ilişkilendirilmiş kullanıcı hesabı
  username: string;
